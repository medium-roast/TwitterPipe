...
ssc = StreamingContext(sc, 1)	# Perform mini-batch process every 1 sec
ssc.checkpoint("checkpoint_TwitterStreamApp")	# Create checkpoint file
dataStream = ssc.socketTextStream("localhost",9090)		# Read data stream from socket on part 9090
